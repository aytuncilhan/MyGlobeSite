  ...
  function (Map, GeoJSONLayer, SceneView, watchUtils) {
    ...
    watchUtils.whenTrue(LeisureLayer, "loaded", function() {
      ...
      setTimeout(function() {
        ...
        view.popup.open({
          location: {longitude: 2, latitude:50},
          fetchFeatures: true
        });
        
        console.log('Popup Lat: ' + view.popup.location.x + ', Popup Lon: ' + view.popup.location.y);
        console.log('Point Lat: ' + point.x + ', Point Lon: ' + point.y);
